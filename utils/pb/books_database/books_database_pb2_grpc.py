...
class BooksDatabaseStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ping = channel.unary_unary(
                '/books_database.BooksDatabase/Ping',
                request_serializer=books__database__pb2.PingRequest.SerializeToString,
                response_deserializer=books__database__pb2.PingResponse.FromString,
                _registered_method=True)
...
def add_BooksDatabaseServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Ping': grpc.unary_unary_rpc_method_handler(
                    servicer.Ping,
                    request_deserializer=books__database__pb2.PingRequest.FromString,
                    response_serializer=books__database__pb2.PingResponse.SerializeToString,
            ),
    }
...
class BooksDatabase(object):
    ...
    def Ping(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/books_database.BooksDatabase/Ping',
            books__database__pb2.PingRequest.SerializeToString,
            books__database__pb2.PingResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
