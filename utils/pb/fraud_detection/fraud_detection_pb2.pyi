...
class InitOrderRequest(_message.Message):
    __slots__ = ("order_id", "user_id", "user_contact", "user_address", "card_number", "order_amount", "vector_clock")
    ...
    def __init__(self, order_id: _Optional[str] = ..., user_id: _Optional[str] = ..., user_contact: _Optional[str] = ..., user_address: _Optional[str] = ..., card_number: _Optional[str] = ..., order_amount: _Optional[str] = ..., vector_clock: _Optional[_Union[VectorClock, _Mapping]] = ...) -> None: ...
